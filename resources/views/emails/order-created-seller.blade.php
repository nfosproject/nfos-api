                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="color: #4b5563; font-size: 15px; margin-bottom: 20px; line-height: 1.7;">
                                You have received a new order that requires your attention. Please process this order as soon as possible.
                            </p>
                            
                            <!-- Order Details Card -->
                            <div style="background-color: #ffffff; border: 1px solid #e5e7eb; border-left: 4px solid #f97316; border-radius: 8px; padding: 24px; margin: 24px 0;">
                            ...
                            <div style="background-color: #fff3e0; border-left: 4px solid #f97316; border-radius: 6px; padding: 16px; margin: 24px 0;">
                                <p style="color: #78350f; margin: 0; font-size: 14px; line-height: 1.6;">
                                    ⚡ <strong>Action Required:</strong> Please process this order as soon as possible. Update the order status in your seller dashboard when ready to ship.
                                </p>
                            </div>
